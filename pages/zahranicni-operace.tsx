...
const DeploymentPage = () => {
  const title = "Zahraniční operace - Tradice výsadkářů";
  const description =
    "Výsadkáři byli a jsou nasazováni všude po světě. Informace o jejich nasazeních a plněných úkolech.";
  const url = "https://tradice.43vysadkovypluk.cz/zahranicni-operace";
  const cardImage =
    "https://tradice.43vysadkovypluk.cz/assets/images/og/zahranicni-operace.png";
